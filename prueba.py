...
# --- Bloque 3: Selección de Manzana ---
# --- Bloque 3: Selección de Manzana con Copia Manual (CON DEPURACIÓN) ---
    ...
    if manzanas_sel.empty:
        ...
        st.write("manzanas_sel", manzanas_sel)
